...
public class JetDiagnosticsTestGenerated extends AbstractDiagnosticsTestWithEagerResolve {
    ...
    public static class Tests extends AbstractDiagnosticsTestWithEagerResolve {
        ...
        public static class CallableReference extends AbstractDiagnosticsTestWithEagerResolve {
            ...
            @TestMetadata("ambiguityLocalVsTopLevel.kt")
            public void testAmbiguityLocalVsTopLevel() throws Exception {
                doTest("compiler/testData/diagnostics/tests/callableReference/ambiguityLocalVsTopLevel.kt");
            }
            
            @TestMetadata("ambiguityMemberVsExtension.kt")
            public void testAmbiguityMemberVsExtension() throws Exception {
                doTest("compiler/testData/diagnostics/tests/callableReference/ambiguityMemberVsExtension.kt");
            }
